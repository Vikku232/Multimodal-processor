...
def render_opencv_page():
    ...
    with row1_cols[0]:
        ...
        if st.button("Extract Entities", key="act_entities", use_container_width=True):
            st.session_state.action = "entities"
            st.rerun()
    ...
    with row1_cols[1]:
        ...
        if st.button("POS Tagging", key="act_pos", use_container_width=True):
            st.session_state.action = "pos"
            st.rerun()
    ...
    with row1_cols[2]:
        ...
        if st.button("Extract Noun Chunks", key="act_noun_chunks", use_container_width=True):
            st.session_state.action = "noun_chunks"
            st.rerun()
    ...
    with row1_cols[3]:
        ...
        if st.button("Tokenize Words", key="act_tokenize", use_container_width=True):
            st.session_state.action = "tokenize"
            st.rerun()
    ...
    with row2_cols[0]:
        ...
        if st.button("Convert Grayscale", key="act_grayscale", use_container_width=True):
            st.session_state.action = "grayscale"
            st.rerun()
    ...
    with row2_cols[1]:
        ...
        if st.button("Edge Detection", key="act_edges", use_container_width=True):
            st.session_state.action = "edges"
            st.rerun()
    ...
    with row2_cols[2]:
        ...
        if st.button("Gaussian Blur", key="act_blur", use_container_width=True):
            st.session_state.action = "blur"
            st.rerun()
    ...
    with row2_cols[3]:
        ...
        if st.button("Invert Colors", key="act_invert", use_container_width=True):
            st.session_state.action = "invert"
            st.rerun()
